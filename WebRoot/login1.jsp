...
<body>
	...
	<div class="login-wrap">
		<div class="login-content">
			...
			<div class="login">
				...
				<div class="username txt"><input type="text" placeholder="username" id="username" name='j_username'/></div>
				<div class="pwd txt"><input type="password" placeholder="password" id="password" name='j_password'/></div>
				<div class="guida-info clear">
					<a class="forget-pwd" href="<%=request.getContextPath()%>/getbackPwd">忘记密码</a>
					<a class="registered" href="<%=request.getContextPath()%>/registration">注册账号</a>
				</div>
	...
	<div class="alibaba"><a href="#">阿里巴巴</a></div>
